...
namespace ArcTexel.Extensions.CommonApi.Diagnostics.Diagnostics;
...
public class UseGenericEnumerableForListArrayDiagnostic : DiagnosticAnalyzer
{
    ...
    public static DiagnosticDescriptor UseGenericEnumerableForListArrayDescriptor { get; } =
        new(DiagnosticId, "Use IEnumerable<T> in Setting instead of List/Array",
            "Use IEnumerable<{0}> instead of {1} to allow passing any IEnumerable<{0}> for the value. Use the {2} extension from ArcTexel.Extensions.CommonApi.UserPreferences.Settings to access the Setting as a {1}.",
            "ArcTexel.CommonAPI", DiagnosticSeverity.Info, true);
