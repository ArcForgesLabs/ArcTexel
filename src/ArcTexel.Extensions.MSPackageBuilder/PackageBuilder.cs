...
namespace ArcTexel.Extensions.MSPackageBuilder;

/// <summary>
///   Class that is used to create .arcext packages. 
/// </summary>
public static class PackageBuilder
{
    ...
    public static void Build(string buildResultDirectory, string targetDirectory, bool encryptedResources)
    {
        ...
        string packagePath = Path.Combine(targetDirectory, $"{metadata.UniqueName}.arcext");
