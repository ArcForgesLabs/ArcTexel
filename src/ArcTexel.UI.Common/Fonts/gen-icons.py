...
SVG_FILE = "defs.svg"
XAML_FILE = "ArcPerfectIcons.axaml"
CS_FILE = "ArcPerfectIcons.axaml.cs"
...
xaml_lines = [
    ...
    '    <Styles.Resources>',
    '        <ResourceDictionary>',
    '            <FontFamily x:Key="ArcPerfectIcons">avares://ArcTexel.UI.Common/Fonts/ArcPerfect.ttf#pixiperfect</FontFamily>',
]
...
# Generate C# content
cs_lines = [
    "public static partial class ArcPerfectIcons",
    "{"
]
