...
You may use the included ArcTexel's dark theme by loading a resource dictionary in XAML:
...
[DefaultColorPickerStyle](https://github.com/ArcTexel/ColorPicker/blob/master/src/ColorPicker/Styles/DefaultColorPickerStyle.xaml)
for reference.
