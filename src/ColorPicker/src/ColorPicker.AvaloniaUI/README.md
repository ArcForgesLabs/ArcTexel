...
[![Download](https://img.shields.io/badge/nuget-download-blue)](https://www.nuget.org/packages/ArcTexel.ColorPicker.AvaloniaUI/)
[![Downloads](https://img.shields.io/nuget/dt/ArcTexel.ColorPicker.AvaloniaUI)](https://www.nuget.org/packages/ArcTexel.ColorPicker/)
...
- ArcPerfectColorPickerTheme - Our custom theme used in ArcTexel
...
<Application ...
 ...
 <Application.Styles>
        ...
        <templates:ArcPerfectColorPickerTheme />
    </Application.Styles>
   ```
...
Use [SimpleColorPickerTheme](https://github.com/ArcTexel/ColorPicker/tree/master/src/ColorPicker.AvaloniaUI/Templates) as a reference.
