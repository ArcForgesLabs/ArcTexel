...
namespace ArcTexel.Extensions.Sdk.Api.UserPreferences;
...
public class Preferences : IPreferences
{
    ...
    /// </summary>
    /// <param name="name">Name of the preference. You can use "ExtensionUniqueName:PreferenceName" or "PreferenceName" schema. To access ArcTexel's built-in preferences, use "ArcTexel:PreferenceName"</param>
