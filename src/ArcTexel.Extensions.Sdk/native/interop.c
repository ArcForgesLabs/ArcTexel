...
MonoMethod* lookup_interop_method(const char* method_name)
{
    ...
    method = lookup_dotnet_method("ArcTexel.Extensions.Sdk.dll", "ArcTexel.Extensions.Sdk.Bridge", "Native", method_name, -1);
    assert(method);
...
void attach_internal_calls()
{
    ...
    mono_add_internal_call("ArcTexel.Extensions.Sdk.Bridge.Native::get_encryption_key", get_encryption_key);
    mono_add_internal_call("ArcTexel.Extensions.Sdk.Bridge.Native::get_encryption_iv", get_encryption_iv);
}
