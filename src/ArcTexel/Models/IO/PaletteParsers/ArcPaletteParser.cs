...
internal class ArcPaletteParser : PaletteFileParser
{
    public override string FileName { get; } = "Palette from ArcTexel .arc";
    public override string[] SupportedFileExtensions { get; } = { ".arc" };
    ...
    private async Task<PaletteFileData> ParseFile(string path)
    {
        ...
        var file = await ArcParser.DeserializeUsingCompatibleAsync(fileStream);
    ...
    {
        throw new SavingNotSupportedException("Saving palette as .arc directly is not supported.");
    }
}
