...
public static class Paths
{
    ...
    public static string TempRenderingPath { get; } = Path.Combine(Path.GetTempPath(), "ArcTexel", "Rendering");

    public static string TempFilesPath { get; } = Path.Combine(Path.GetTempPath(), "ArcTexel");
    public static string TempResourcesPath { get; } = Path.Combine(Path.GetTempPath(), "ArcTexel", "Resources");

    /// <summary>
    /// Path to %temp%/ArcTexel/Autosave
    /// </summary>
