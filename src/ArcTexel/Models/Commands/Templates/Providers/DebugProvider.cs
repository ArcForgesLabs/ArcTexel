...
namespace ArcTexel.Models.Commands.Templates.Providers;
...
internal partial class ShortcutProvider
{
    ...
    internal class DebugProvider : Templates.ShortcutProvider, IShortcutDefaults, IShortcutFile, IShortcutInstallation
    {
        ...
        public List<Shortcut> DefaultShortcuts { get; } = new()
        {
            ...
            new Shortcut(Key.Z, KeyModifiers.Control, "ArcTexel.Undo.Undo"),
            new Shortcut(Key.Y, KeyModifiers.Control, "ArcTexel.Undo.Redo"),
            new Shortcut(Key.X, KeyModifiers.None, "ArcTexel.Colors.Swap")
        };
