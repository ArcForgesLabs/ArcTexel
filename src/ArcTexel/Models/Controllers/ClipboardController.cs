...
using ArcTexel.Helpers.Constants;
...
{
    public static IArcTexelClipboard Clipboard { get; private set; }

    public static void Initialize(IArcTexelClipboard clipboard)
    {
        Clipboard = clipboard;
    }
