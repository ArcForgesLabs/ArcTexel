...
namespace ArcTexel.Models.AnalyticsAPI;
...
public class AnalyticsPeriodicReporter
{
    ...
    public AnalyticsPeriodicReporter(AnalyticsClient client)
    {
        ...
        if (ArcTexelSettings.Analytics.AnalyticsEnabled != null)
        {
            ArcTexelSettings.Analytics.AnalyticsEnabled.ValueChanged += EnableAnalyticsOnValueChanged;
        }
    }

    public void Start(Guid? sessionId)
    {
        if (!ArcTexelSettings.Analytics.AnalyticsEnabled.Value)
            return;
