...
public class WindowProvider : IWindowProvider
{
    ...
    internal WindowProvider(ExtensionLoader loader, IServiceProvider services)
    {
        ...
        ArcTexelPopup.PopupLoaded += ArcTexelPopupOnPopupLoaded;
        ArcTexelPopup.PopupClosed += ArcTexelPopupOnPopupClosed;
    }

    private void ArcTexelPopupOnPopupLoaded(ArcTexelPopup obj)
    {
    ...
    private void ArcTexelPopupOnPopupClosed(ArcTexelPopup obj)
    {
    ...
    {
        return new PopupWindow(new ArcTexelPopup { Title = title, Content = body });
    }

    public IPopupWindow GetWindow(BuiltInWindowType type)
    {
        string id = type.GetDescription();
        return GetWindow($"ArcTexel.{id}");
    }
