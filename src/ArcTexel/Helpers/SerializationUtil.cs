...
public static class SerializationUtil
{
        ...
        (string serializerName, string serializerVersion) serializerData)
    {
        if (IsComplexObject(value))
        {
            ...
            if (factory is null)
            {
                string normalizedId = NormalizeLegacyDeserializationId(id);
                factory = allFactories.FirstOrDefault(x => x.DeserializationId == normalizedId);
            }
    ...
    private static string NormalizeLegacyDeserializationId(string id)
    {
