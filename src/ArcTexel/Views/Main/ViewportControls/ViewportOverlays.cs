...
using ArcTexel.Models.Commands.XAML;
using ArcTexel.Models.Handlers.Tools;
using ArcTexel.ViewModels;
using ArcTexel.ViewModels.Document.TransformOverlays;
using ArcTexel.Views.Overlays;
using ArcTexel.Views.Overlays.BrushShapeOverlay;
using ArcTexel.Views.Overlays.LineToolOverlay;
using ArcTexel.Views.Overlays.PathOverlay;
using ArcTexel.Views.Overlays.Pointers;
using ArcTexel.Views.Overlays.SelectionOverlay;
using ArcTexel.Views.Overlays.SymmetryOverlay;
using ArcTexel.Views.Overlays.TextOverlay;
using ArcTexel.Views.Overlays.TransformOverlay;

namespace ArcTexel.Views.Main.ViewportControls;
...
internal class ViewportOverlays
{
    ...
    private void BindSymmetryOverlay()
    {
        ...
        symmetryOverlay.DragCommand =
            (ICommand)new Command("ArcTexel.Document.DragSymmetry") { UseProvided = true }.ProvideValue(null);
        symmetryOverlay.DragEndCommand =
            (ICommand)new Command("ArcTexel.Document.EndDragSymmetry") { UseProvided = true }.ProvideValue(null);
        symmetryOverlay.DragStartCommand =
            (ICommand)new Command("ArcTexel.Document.StartDragSymmetry") { UseProvided = true }.ProvideValue(null);
    }
