...
using CommandSearchResult = ArcTexel.Models.Commands.Search.CommandSearchResult;
using Search_CommandSearchResult = ArcTexel.Models.Commands.Search.CommandSearchResult;

namespace ArcTexel.Views.Main.CommandSearch;
