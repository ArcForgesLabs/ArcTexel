...
internal class LocalizationDataContext : ArcObservableObject
{
    ...
    public string ApiKey
    {
        ...
        set
        {
            ...
            {
                ArcTexelSettings.Debug.PoEditorApiKey.Value = value;
    ...
    public LocalizationDataContext()
    {
        ...
        apiKey = ArcTexelSettings.Debug.PoEditorApiKey.Value;
    ...
    {
        const string fileName = "ArcTexel.csproj";
