...
using ArcTexel.Views.Input;
using ArcTexel.Views.Palettes;
using PaletteColor = ArcTexel.Extensions.CommonApi.Palettes.PaletteColor;
using ViewModelMain = ArcTexel.ViewModels.ViewModelMain;

namespace ArcTexel.Views.Windows;

internal partial class PalettesBrowser : ArcTexelPopup, IPopupWindow
{
    ...
    public FilteringSettings Filtering => filteringSettings ??=
        new FilteringSettings(ColorsNumberMode, ColorsNumber, NameFilter, ShowOnlyFavourites,
            ArcTexelSettings.Palettes.FavouritePalettes.AsList());
    ...
    public PalettesBrowser(ColorsViewModel vm)
    {
        ...
        ArcTexelSettings.Palettes.FavouritePalettes.ValueChanged += OnFavouritePalettesChanged;
    }
    ...
    {
        Filtering.Favourites = ArcTexelSettings.Palettes.FavouritePalettes.AsList();
    }
    ...
    private async void ToggleFavourite(Palette palette)
    {
        ...
        var favouritePalettes = ArcTexelSettings.Palettes.FavouritePalettes.AsList();
        ...
        ArcTexelSettings.Palettes.FavouritePalettes.Value = favouritePalettes;
        await UpdatePaletteList();
    }
    ...
    {
        var favourites = ArcTexelSettings.Palettes.FavouritePalettes.AsList();
        ...
        ArcTexelSettings.Palettes.FavouritePalettes.Value = favourites;
    }
