...
using Command = ArcTexel.Models.Commands.Commands.Command;
using Commands_Command = ArcTexel.Models.Commands.Commands.Command;
using NativeMenu = Avalonia.Controls.NativeMenu;

namespace ArcTexel.ViewModels.Menu;

internal class MenuBarViewModel : ArcObservableObject
{
    private AdditionalContentViewModel additionalContentViewModel;
    private UpdateViewModel updateViewModel;
    private UserViewModel userViewModel;
    private ExecutionTrigger _openArcTexelMenuTrigger;
    ...
    public ExecutionTrigger OpenArcTexelMenuTrigger
    {
        get => _openArcTexelMenuTrigger;
        set => SetProperty(ref _openArcTexelMenuTrigger, value);
    }
        ...
        UserViewModel? userViewModel)
    {
        ...
        UserViewModel = userViewModel;
        OpenArcTexelMenuTrigger = new ExecutionTrigger();
    }
    ...
    private void BuildMenu(CommandController controller)
    {
        ...
        else
        {
            ...
            {
                OpenArcTexelMenuTrigger.Execute(this);
            });
        }
    }
