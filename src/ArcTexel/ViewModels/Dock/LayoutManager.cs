...
internal class LayoutManager
{
    ...
    public void InitLayout(ViewModelMain mainViewModel)
    {
        ...
        */
        ...
        HostWindow.ForceUseSystemDecorations = ArcTexelSettings.Appearance.UseSystemDecorations.Value;

        ArcTexelSettings.Appearance.UseSystemDecorations.ValueChanged += (_, val) =>
        {
