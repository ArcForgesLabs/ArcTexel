...
internal class SceneSettings : SettingsGroup
{
    ...
    public bool SelectionTintingEnabled
    {
        ...
        set => RaiseAndUpdatePreference(ArcTexelSettings.Tools.SelectionTintingEnabled, value);
    }
    ...
    public SceneSettings()
    {
        ...
        SubscribeValueChanged(ArcTexelSettings.Tools.SelectionTintingEnabled, nameof(SelectionTintingEnabled));
    }
}
