...
internal class OnboardingViewModel : ArcObservableObject
{
    private int page;
    ...
    public OnboardingViewModel()
    {
        ...
        bool showFoundersBundle = ViewModelMain.Current.UserViewModel.OwnedProducts
            .All(x => x.ProductData.Id != "2435860" && x.ProductData.Id != "ArcTexel.FoundersPack");
        ...
        Templates.Insert(0,
            new SelectionCard<ShortcutProvider>(
                new ShortcutProvider("ArcTexel")
                {
                    LogoPath = "/Images/ArcTexelLogo.svg", HoverLogoPath = "/Images/ArcTexelLogo.svg"
                },
