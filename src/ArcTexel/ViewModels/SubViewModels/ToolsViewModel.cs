...
using ArcTexel.Helpers.UI;
using ArcTexel.Models.BrushEngine;
using ArcTexel.Models.Commands;
using ArcTexel.Models.DocumentModels.Public;
...
#nullable enable
[Command.Group("ArcTexel.Tools", "TOOLS")]
internal class ToolsViewModel : SubViewModel<ViewModelMain>, IToolsHandler
{
    private RightClickMode rightClickMode = ArcTexelSettings.Tools.RightClickMode.Value;
    ...
    public RightClickMode RightClickMode
    {
        ...
        set
        {
            ...
            {
                ArcTexelSettings.Tools.RightClickMode.Value = value;
            }
        }
    }
    ...
    {
        get => ArcTexelSettings.Tools.EnableSharedToolbar.Value;
        set
        {
            ...
            ArcTexelSettings.Tools.EnableSharedToolbar.Value = value;
    ...
    {
        get => ArcTexelSettings.Tools.SelectionTintingEnabled.Value;
        set
        {
            if (SelectionTintingEnabled == value)
                return;

            ArcTexelSettings.Tools.SelectionTintingEnabled.Value = value;
            OnPropertyChanged();
        }
    }
        ...
        : base(owner)
    {
        ...
        ArcTexelSettings.Tools.PrimaryToolset.ValueChanged += PrimaryToolsetOnValueChanged;
        SubscribeSettingsValueChanged(ArcTexelSettings.Tools.SelectionTintingEnabled,
    ...
    [Command.Internal("ArcTexel.Tools.SetActiveToolSet", AnalyticsTrack = true)]
    ...
    [Command.Basic("ArcTexel.Tools.ToggleSelectionTinting", "TOGGLE_TINTING_SELECTION",
    ...
    [Command.Basic("ArcTexel.Tools.ApplyTransform", "APPLY_TRANSFORM", "", Key = Key.Enter, AnalyticsTrack = true)]
    ...
    [Command.Internal("ArcTexel.Tools.SwitchToolSet", AnalyticsTrack = true,
        CanExecute = "ArcTexel.HasNextToolSet")]
    [Command.Basic("ArcTexel.Tools.NextToolSet", true, "NEXT_TOOL_SET", "NEXT_TOOL_SET",
        Modifiers = KeyModifiers.Shift,
        Key = Key.E, AnalyticsTrack = true)]
    [Command.Basic("ArcTexel.Tools.PreviousToolSet", false, "PREVIOUS_TOOL_SET", "PREVIOUS_TOOL_SET",
        Modifiers = KeyModifiers.Shift,
    ...
    [Evaluator.CanExecute("ArcTexel.HasNextToolSet",
    ...
    [Command.Internal("ArcTexel.Tools.SelectTool", CanExecute = "ArcTexel.HasDocument")]
    ...
    [Command.Basic("ArcTexel.Tools.IncreaseSize", 1d, "INCREASE_TOOL_SIZE", "INCREASE_TOOL_SIZE",
        CanExecute = "ArcTexel.Tools.CanChangeToolSize", Key = Key.OemCloseBrackets, AnalyticsTrack = true)]
    [Command.Basic("ArcTexel.Tools.DecreaseSize", -1d, "DECREASE_TOOL_SIZE", "DECREASE_TOOL_SIZE",
        CanExecute = "ArcTexel.Tools.CanChangeToolSize", Key = Key.OemOpenBrackets, AnalyticsTrack = true)]
    ...
    [Evaluator.CanExecute("ArcTexel.Tools.CanChangeToolSize",
        nameof(ActiveTool))]
    ...
    {
        var primaryToolSet = ArcTexelSettings.Tools.PrimaryToolset.Value;
            ...
            foreach (var toolFromToolset in toolSet.Tools)
            {
                ...
                if (!string.IsNullOrEmpty(toolFromToolset.Icon ?? toolConfig.Icon))
                {
                    toolSetViewModel.IconOverwrites[tool] =
                        ArcPerfectIconExtensions.TryGetByName(toolFromToolset.Icon ?? toolConfig.Icon) ??
                        ArcPerfectIcons.Placeholder;
                }
    ...
    private IToolHandler? TryCreateBrushTool(ToolConfig toolFromToolset)
    {
        if (!string.IsNullOrEmpty(toolFromToolset.Brush))
        {
            try
            {
                ...
                {
                    path = "avares://ArcTexel/Data" + toolFromToolset.Brush;
                }
