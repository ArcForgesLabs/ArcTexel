...
internal class RegistryViewModel : SubViewModel<ViewModelMain>
{
    ...
    // TODO: ArcTexel shouldn't handle any registry stuff. It should be handled by the installers.

    /*private void OwnerOnStartupEvent(object sender, EventArgs e)
    {
#if !STEAM // Something is wrong with Steam version of ArcTexel, so we disable this feature for now. Steam will have native association soon.
