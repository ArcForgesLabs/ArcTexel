    ...
    IDockableSelectionEvents, IViewport
{
    ...
    public ViewportWindowViewModel(WindowViewModel owner, DocumentViewModel document) : base(owner)
    {
        ...
        AutoScaleBackground = ArcTexelSettings.Scene.AutoScaleBackground.Value;
        CustomBackgroundScaleX = ArcTexelSettings.Scene.CustomBackgroundScaleX.Value;
        CustomBackgroundScaleY = ArcTexelSettings.Scene.CustomBackgroundScaleY.Value;
        BackgroundBitmap = BitmapFromColors(
            ArcTexelSettings.Scene.PrimaryBackgroundColor.Value,
            ArcTexelSettings.Scene.SecondaryBackgroundColor.Value);

        ArcTexelSettings.Scene.AutoScaleBackground.ValueChanged += UpdateAutoScaleBackground;
        ArcTexelSettings.Scene.CustomBackgroundScaleX.ValueChanged += UpdateCustomBackgroundScaleX;
        ArcTexelSettings.Scene.CustomBackgroundScaleY.ValueChanged += UpdateCustomBackgroundScaleY;
        ArcTexelSettings.Scene.PrimaryBackgroundColor.ValueChanged += UpdateBackgroundBitmap;
        ArcTexelSettings.Scene.SecondaryBackgroundColor.ValueChanged += UpdateBackgroundBitmap;
