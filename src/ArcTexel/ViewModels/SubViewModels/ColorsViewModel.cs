...
using ArcTexel.Models.ExternalServices;
...
using ContextMenu = ArcTexel.Models.Commands.XAML.ContextMenu;
using XAML_ContextMenu = ArcTexel.Models.Commands.XAML.ContextMenu;

namespace ArcTexel.ViewModels.SubViewModels;

[Commands_Command.Group("ArcTexel.Colors", "PALETTE_COLORS")]
internal class ColorsViewModel : SubViewModel<ViewModelMain>, IColorsHandler
{
    ...
    [Evaluator.CanExecute("ArcTexel.Colors.CanReplaceColors", nameof(DocumentManagerViewModel.ActiveDocument))]
    public bool CanReplaceColors()
    {
        return ViewModelMain.Current?.DocumentManagerSubViewModel?.ActiveDocument is not null;
    }

    [Commands_Command.Internal("ArcTexel.Colors.ReplaceColors")]
    ...
    [Commands_Command.Basic("ArcTexel.Colors.ReplaceSecondaryByPrimaryColor", false, "REPLACE_SECONDARY_BY_PRIMARY",
        "REPLACE_SECONDARY_BY_PRIMARY", IconEvaluator = "ArcTexel.Colors.ReplaceColorIcon", AnalyticsTrack = true)]
    [Commands_Command.Basic("ArcTexel.Colors.ReplacePrimaryBySecondaryColor", true, "REPLACE_PRIMARY_BY_SECONDARY",
        "REPLACE_PRIMARY_BY_SECONDARY_DESCRIPTIVE", IconEvaluator = "ArcTexel.Colors.ReplaceColorIcon",
        AnalyticsTrack = true)]
    ...
    [Evaluator.Icon("ArcTexel.Colors.ReplaceColorIcon")]
    ...
    [Commands_Command.Basic("ArcTexel.Colors.OpenPaletteBrowser", "OPEN_PALETTE_BROWSER", "OPEN_PALETTE_BROWSER",
        Icon = ArcPerfectIcons.Database, MenuItemPath = "VIEW/OPEN_PALETTE_BROWSER", MenuItemOrder = 3,
        AnalyticsTrack = true)]
    ...
    [Evaluator.CanExecute("ArcTexel.Colors.CanImportPalette", nameof(DocumentManagerViewModel.ActiveDocument))]
    ...
    [Commands_Command.Internal("ArcTexel.Colors.ImportPalette", CanExecute = "ArcTexel.Colors.CanImportPalette",
        AnalyticsTrack = true)]
    ...
    [Evaluator.CanExecute("ArcTexel.Colors.CanSelectPaletteColor", nameof(DocumentManagerViewModel.ActiveDocument),
    ...
    [Evaluator.Icon("ArcTexel.Colors.FirstPaletteColorIcon")]
    public IImage GetPaletteColorIcon1() => GetPaletteColorIcon(0);

    [Evaluator.Icon("ArcTexel.Colors.SecondPaletteColorIcon")]
    public IImage GetPaletteColorIcon2() => GetPaletteColorIcon(1);

    [Evaluator.Icon("ArcTexel.Colors.ThirdPaletteColorIcon")]
    public IImage GetPaletteColorIcon3() => GetPaletteColorIcon(2);

    [Evaluator.Icon("ArcTexel.Colors.FourthPaletteColorIcon")]
    public IImage GetPaletteColorIcon4() => GetPaletteColorIcon(3);

    [Evaluator.Icon("ArcTexel.Colors.FifthPaletteColorIcon")]
    public IImage GetPaletteColorIcon5() => GetPaletteColorIcon(4);

    [Evaluator.Icon("ArcTexel.Colors.SixthPaletteColorIcon")]
    public IImage GetPaletteColorIcon6() => GetPaletteColorIcon(5);

    [Evaluator.Icon("ArcTexel.Colors.SeventhPaletteColorIcon")]
    public IImage GetPaletteColorIcon7() => GetPaletteColorIcon(6);

    [Evaluator.Icon("ArcTexel.Colors.EighthPaletteColorIcon")]
    public IImage GetPaletteColorIcon8() => GetPaletteColorIcon(7);

    [Evaluator.Icon("ArcTexel.Colors.NinthPaletteColorIcon")]
    public IImage GetPaletteColorIcon9() => GetPaletteColorIcon(8);

    [Evaluator.Icon("ArcTexel.Colors.TenthPaletteColorIcon")]
    ...
    [Commands_Command.Basic("ArcTexel.Colors.SelectFirstPaletteColor", "SELECT_COLOR_1", "SELECT_COLOR_1_DESCRIPTIVE",
        Key = Key.D1, Parameter = 0, CanExecute = "ArcTexel.Colors.CanSelectPaletteColor",
        IconEvaluator = "ArcTexel.Colors.FirstPaletteColorIcon", AnalyticsTrack = true)]
    [Commands_Command.Basic("ArcTexel.Colors.SelectSecondPaletteColor", "SELECT_COLOR_2",
        "SELECT_COLOR_2_DESCRIPTIVE", Key = Key.D2, Parameter = 1,
        CanExecute = "ArcTexel.Colors.CanSelectPaletteColor",
        IconEvaluator = "ArcTexel.Colors.SecondPaletteColorIcon", AnalyticsTrack = true)]
    [Commands_Command.Basic("ArcTexel.Colors.SelectThirdPaletteColor", "SELECT_COLOR_3", "SELECT_COLOR_3_DESCRIPTIVE",
        Key = Key.D3, Parameter = 2, CanExecute = "ArcTexel.Colors.CanSelectPaletteColor",
        IconEvaluator = "ArcTexel.Colors.ThirdPaletteColorIcon", AnalyticsTrack = true)]
    [Commands_Command.Basic("ArcTexel.Colors.SelectFourthPaletteColor", "SELECT_COLOR_4",
        "SELECT_COLOR_4_DESCRIPTIVE", Key = Key.D4, Parameter = 3,
        CanExecute = "ArcTexel.Colors.CanSelectPaletteColor",
        IconEvaluator = "ArcTexel.Colors.FourthPaletteColorIcon", AnalyticsTrack = true)]
    [Commands_Command.Basic("ArcTexel.Colors.SelectFifthPaletteColor", "SELECT_COLOR_5", "SELECT_COLOR_5_DESCRIPTIVE",
        Key = Key.D5, Parameter = 4, CanExecute = "ArcTexel.Colors.CanSelectPaletteColor",
        IconEvaluator = "ArcTexel.Colors.FifthPaletteColorIcon", AnalyticsTrack = true)]
    [Commands_Command.Basic("ArcTexel.Colors.SelectSixthPaletteColor", "SELECT_COLOR_6", "SELECT_COLOR_6_DESCRIPTIVE",
        Key = Key.D6, Parameter = 5, CanExecute = "ArcTexel.Colors.CanSelectPaletteColor",
        IconEvaluator = "ArcTexel.Colors.SixthPaletteColorIcon", AnalyticsTrack = true)]
    [Commands_Command.Basic("ArcTexel.Colors.SelectSeventhPaletteColor", "SELECT_COLOR_7",
        "SELECT_COLOR_7_DESCRIPTIVE", Key = Key.D7, Parameter = 6,
        CanExecute = "ArcTexel.Colors.CanSelectPaletteColor",
        IconEvaluator = "ArcTexel.Colors.SeventhPaletteColorIcon", AnalyticsTrack = true)]
    [Commands_Command.Basic("ArcTexel.Colors.SelectEighthPaletteColor", "SELECT_COLOR_8",
        "SELECT_COLOR_8_DESCRIPTIVE", Key = Key.D8, Parameter = 7,
        CanExecute = "ArcTexel.Colors.CanSelectPaletteColor",
        IconEvaluator = "ArcTexel.Colors.EighthPaletteColorIcon", AnalyticsTrack = true)]
    [Commands_Command.Basic("ArcTexel.Colors.SelectNinthPaletteColor", "SELECT_COLOR_9", "SELECT_COLOR_9_DESCRIPTIVE",
        Key = Key.D9, Parameter = 8, CanExecute = "ArcTexel.Colors.CanSelectPaletteColor",
        IconEvaluator = "ArcTexel.Colors.NinthPaletteColorIcon", AnalyticsTrack = true)]
    [Commands_Command.Basic("ArcTexel.Colors.SelectTenthPaletteColor", "SELECT_COLOR_10",
        "SELECT_COLOR_10_DESCRIPTIVE", Key = Key.D0, Parameter = 9,
        CanExecute = "ArcTexel.Colors.CanSelectPaletteColor",
        IconEvaluator = "ArcTexel.Colors.TenthPaletteColorIcon", AnalyticsTrack = true)]
    ...
    [Commands_Command.Basic("ArcTexel.Colors.Swap", "SWAP_COLORS", "SWAP_COLORS_DESCRIPTIVE", Key = Key.X,
        Icon = ArcPerfectIcons.ColorsSwap, AnalyticsTrack = true)]
    ...
    [Commands_Command.Internal("ArcTexel.Colors.RemoveSwatch")]
    ...
    [Commands_Command.Internal("ArcTexel.Colors.SelectColor")]
    ...
    [Commands_Command.Basic("ArcTexel.Colors.AddPrimaryToPalettes", "ADD_PRIMARY_COLOR_TO_PALETTE",
        "ADD_PRIMARY_COLOR_TO_PALETTE_DESCRIPTIVE", CanExecute = "ArcTexel.HasDocument",
        Icon = ArcPerfectIcons.Duplicate, AnalyticsTrack = true)]
    ...
    [Commands_Command.Internal("ArcTexel.CloseContextMenu")]
