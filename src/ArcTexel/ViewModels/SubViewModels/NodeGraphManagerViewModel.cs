...
using ArcTexel.Models.Blackboard;
...
internal class NodeGraphManagerViewModel : SubViewModel<ViewModelMain>
{
    ...
    [Command.Basic("ArcTexel.NodeGraph.DeleteSelectedNodes", "DELETE_NODES", "DELETE_NODES_DESCRIPTIVE", 
    ...
    // TODO: Remove this
    [Command.Debug("ArcTexel.NodeGraph.CreateNodeFrameAroundEverything", "Create node frame", "Create node frame", AnalyticsTrack = true)]
    ...
    [Command.Internal("ArcTexel.NodeGraph.CreateNode")]
    ...
    [Command.Internal("ArcTexel.NodeGraph.ConnectProperties")]
    ...
    [Command.Internal("ArcTexel.NodeGraph.ChangeNodePos")]
    ...
    [Command.Internal("ArcTexel.NodeGraph.UpdateValue", AnalyticsTrack = true)]
    ...
    [Command.Internal("ArcTexel.NodeGraph.BeginUpdateValue", AnalyticsTrack = true)]
    ...
    [Command.Internal("ArcTexel.NodeGraph.AddVariable")]
