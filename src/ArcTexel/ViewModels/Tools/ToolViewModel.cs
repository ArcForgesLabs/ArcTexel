...
internal abstract class ToolViewModel : ObservableObject, IToolHandler
{
    ...
    public virtual string DefaultIcon => ArcPerfectIcons.Placeholder;
    ...
    /// <summary>
    /// Determines if ArcTexel should switch to the Eraser when right click mode is set to erase
    /// </summary>
    ...
    public bool IsArcPerfectIcon => !Uri.TryCreate(IconToUse, UriKind.Absolute, out _);
