...
using ArcTexel.Helpers.Collections;
...
using ArcTexel.ViewModels.Document.Nodes.Workspace;
...
#nullable enable
internal partial class DocumentViewModel : ArcObservableObject, IDocument
{
    ...
    public static DocumentViewModel Build(Action<DocumentViewModelBuilder> builder)
    {
        ...
        if (builderInstance.UsesSrgbColorBlending ||
            IsFileWithSrgbColorBlending(serializerData, builderInstance.ArcParserVersionUsed))
        {
        ...
        bool IsFileWithSrgbColorBlending((string serializerName, string serializerVersion) serializerData,
            Version? arcParserVersionUsed)
        {
            if (arcParserVersionUsed != null && arcParserVersionUsed.Major < 5)
            {
                return true;
            }
            ...
            try
            {
                ...
                return serializerData.serializerName == "ArcTexel"
