...
#nullable enable
[Command.Group("ArcTexel.Document", "IMAGE")]
internal class DocumentManagerViewModel : SubViewModel<ViewModelMain>, IDocumentManagerHandler
{
    ...
    [Evaluator.CanExecute("ArcTexel.HasDocument", nameof(ActiveDocument))]
    public bool DocumentNotNull() => ActiveDocument != null;

    [Command.Basic("ArcTexel.Document.Open", "OPEN_DOCUMENT", "OPEN_DOCUMENT_DESC",
        Icon = ArcPerfectIcons.File, AnalyticsTrack = true)]
    ...
    [Command.Basic("ArcTexel.Document.ClipCanvas", "CLIP_CANVAS", "CLIP_CANVAS",
        CanExecute = "ArcTexel.HasDocument",
        Icon = ArcPerfectIcons.Crop, MenuItemPath = "IMAGE/CLIP_CANVAS", MenuItemOrder = 2, AnalyticsTrack = true)]
    public void ClipCanvas() => ActiveDocument?.Operations.ClipCanvas();

    [Command.Basic("ArcTexel.Document.FlipImageHorizontal", FlipType.Horizontal, "FLIP_IMG_HORIZONTALLY",
        "FLIP_IMG_HORIZONTALLY", CanExecute = "ArcTexel.HasDocument",
        MenuItemPath = "IMAGE/FLIP/FLIP_IMG_HORIZONTALLY", MenuItemOrder = 14, Icon = ArcPerfectIcons.XFlip,
        AnalyticsTrack = true)]
    [Command.Basic("ArcTexel.Document.FlipImageVertical", FlipType.Vertical, "FLIP_IMG_VERTICALLY",
        "FLIP_IMG_VERTICALLY", CanExecute = "ArcTexel.HasDocument",
        MenuItemPath = "IMAGE/FLIP/FLIP_IMG_VERTICALLY", MenuItemOrder = 15, Icon = ArcPerfectIcons.Image180,
        AnalyticsTrack = true)]
    ...
    [Command.Basic("ArcTexel.Document.FlipLayersHorizontal", FlipType.Horizontal, "FLIP_LAYERS_HORIZONTALLY",
        "FLIP_LAYERS_HORIZONTALLY", CanExecute = "ArcTexel.HasDocument",
        MenuItemPath = "LAYER/FLIP/FLIP_LAYERS_HORIZONTALLY", MenuItemOrder = 16,
        Icon = ArcPerfectIcons.MirrorHorizontal,
        AnalyticsTrack = true)]
    [Command.Basic("ArcTexel.Document.FlipLayersVertical", FlipType.Vertical, "FLIP_LAYERS_VERTICALLY",
        "FLIP_LAYERS_VERTICALLY", CanExecute = "ArcTexel.HasDocument",
        MenuItemPath = "LAYER/FLIP/FLIP_LAYERS_VERTICALLY", MenuItemOrder = 17, Icon = ArcPerfectIcons.MirrorVertical,
        AnalyticsTrack = true)]
    ...
    [Command.Basic("ArcTexel.Document.Rotate90Deg", "ROT_IMG_90",
        "ROT_IMG_90", CanExecute = "ArcTexel.HasDocument", Parameter = RotationAngle.D90,
        MenuItemPath = "IMAGE/ROTATION/ROT_IMG_90_D", MenuItemOrder = 8, Icon = ArcPerfectIcons.Image90,
        AnalyticsTrack = true)]
    [Command.Basic("ArcTexel.Document.Rotate180Deg", "ROT_IMG_180",
        "ROT_IMG_180", CanExecute = "ArcTexel.HasDocument", Parameter = RotationAngle.D180,
        MenuItemPath = "IMAGE/ROTATION/ROT_IMG_180_D", MenuItemOrder = 9, Icon = ArcPerfectIcons.Image180,
        AnalyticsTrack = true)]
    [Command.Basic("ArcTexel.Document.Rotate270Deg", "ROT_IMG_-90",
        "ROT_IMG_-90", CanExecute = "ArcTexel.HasDocument", Parameter = RotationAngle.D270,
        MenuItemPath = "IMAGE/ROTATION/ROT_IMG_-90_D", MenuItemOrder = 10, Icon = ArcPerfectIcons.ImageMinus90,
        AnalyticsTrack = true)]
    public void RotateImage(RotationAngle angle) => ActiveDocument?.Operations.RotateImage(angle);

    [Command.Basic("ArcTexel.Document.Rotate90DegLayers", "ROT_LAYERS_90",
        "ROT_LAYERS_90", CanExecute = "ArcTexel.HasDocument", Parameter = RotationAngle.D90,
        MenuItemPath = "LAYER/ROTATION/ROT_LAYERS_90_D", MenuItemOrder = 11, Icon = ArcPerfectIcons.File90,
        AnalyticsTrack = true)]
    [Command.Basic("ArcTexel.Document.Rotate180DegLayers", "ROT_LAYERS_180",
        "ROT_LAYERS_180", CanExecute = "ArcTexel.HasDocument", Parameter = RotationAngle.D180,
        MenuItemPath = "LAYER/ROTATION/ROT_LAYERS_180_D", MenuItemOrder = 12, Icon = ArcPerfectIcons.File180,
        AnalyticsTrack = true)]
    [Command.Basic("ArcTexel.Document.Rotate270DegLayers", "ROT_LAYERS_-90",
        "ROT_LAYERS_-90", CanExecute = "ArcTexel.HasDocument", Parameter = RotationAngle.D270,
        MenuItemPath = "LAYER/ROTATION/ROT_LAYERS_-90_D", MenuItemOrder = 13, Icon = ArcPerfectIcons.FileMinus90,
        AnalyticsTrack = true)]
    ...
    [Command.Basic("ArcTexel.Document.ToggleVerticalSymmetryAxis", "TOGGLE_VERT_SYMMETRY_AXIS",
        "TOGGLE_VERT_SYMMETRY_AXIS", CanExecute = "ArcTexel.HasDocument",
        Icon = ArcPerfectIcons.YSymmetry, AnalyticsTrack = true)]
    ...
    [Command.Basic("ArcTexel.Document.ToggleHorizontalSymmetryAxis", "TOGGLE_HOR_SYMMETRY_AXIS",
        "TOGGLE_HOR_SYMMETRY_AXIS", CanExecute = "ArcTexel.HasDocument",
        Icon = ArcPerfectIcons.XSymmetry, AnalyticsTrack = true)]
    ...
    [Command.Internal("ArcTexel.Document.DragSymmetry", CanExecute = "ArcTexel.HasDocument")]
    ...
    [Command.Internal("ArcTexel.Document.StartDragSymmetry", CanExecute = "ArcTexel.HasDocument",
        AnalyticsTrack = true)]
    ...
    [Command.Internal("ArcTexel.Document.EndDragSymmetry", CanExecute = "ArcTexel.HasDocument")]
    ...
    [Command.Basic("ArcTexel.Document.DeleteSelected", "DELETE_SELECTED", "DELETE_SELECTED_DESCRIPTIVE",
        Key = Key.Delete,
        ShortcutContexts = [typeof(ViewportWindowViewModel)],
        Icon = ArcPerfectIcons.Eraser,
    ...
    [Command.Basic("ArcTexel.Document.ResizeDocument", false, "RESIZE_DOCUMENT", "RESIZE_DOCUMENT",
        CanExecute = "ArcTexel.HasDocument", Key = Key.I, Modifiers = KeyModifiers.Control | KeyModifiers.Shift,
        Icon = ArcPerfectIcons.Resize, MenuItemPath = "IMAGE/RESIZE_IMAGE", MenuItemOrder = 0, AnalyticsTrack = true)]
    [Command.Basic("ArcTexel.Document.ResizeCanvas", true, "RESIZE_CANVAS", "RESIZE_CANVAS",
        CanExecute = "ArcTexel.HasDocument", Key = Key.C, Modifiers = KeyModifiers.Control | KeyModifiers.Shift,
        Icon = ArcPerfectIcons.CanvasResize, MenuItemPath = "IMAGE/RESIZE_CANVAS", MenuItemOrder = 1,
        AnalyticsTrack = true)]
    ...
    [Command.Basic("ArcTexel.Document.CenterContent", "CENTER_CONTENT", "CENTER_CONTENT",
        CanExecute = "ArcTexel.HasDocument",
        Icon = ArcPerfectIcons.Center, MenuItemPath = "IMAGE/CENTER_CONTENT", MenuItemOrder = 3,
        AnalyticsTrack = true)]
    ...
    [Command.Basic("ArcTexel.Document.UseLinearSrgbProcessing", "USE_LINEAR_SRGB_PROCESSING",
        "USE_LINEAR_SRGB_PROCESSING_DESC", CanExecute = "ArcTexel.DocumentUsesSrgbBlending",
        AnalyticsTrack = true)]
    ...
    [Command.Basic("ArcTexel.Document.UseSrgbProcessing", "USE_SRGB_PROCESSING",
        "USE_SRGB_PROCESSING_DESC", CanExecute = "ArcTexel.DocumentUsesLinearBlending",
        AnalyticsTrack = true)]
    ...
    [Command.Internal("ArcTexel.Document.LoadLazyDocument")]
    ...
    [Evaluator.CanExecute("ArcTexel.DocumentUsesSrgbBlending", nameof(ActiveDocument),
        nameof(ActiveDocument.UsesSrgbBlending))]
    public bool DocumentUsesSrgbBlending() => ActiveDocument?.UsesSrgbBlending ?? false;

    [Evaluator.CanExecute("ArcTexel.DocumentUsesLinearBlending", nameof(ActiveDocument),
        nameof(ActiveDocument.UsesSrgbBlending))]
