...
using ArcTexel.Models.IO.FileEncoders;
...
using IKeyFrameChildrenContainer = ArcTexel.ChangeableDocument.Changeables.Interfaces.IKeyFrameChildrenContainer;
using KeyFrameData = ArcTexel.Parser.KeyFrameData;
using Node = ArcTexel.Parser.Graph.Node;
using NodeGraph = ArcTexel.Parser.Graph.NodeGraph;
using ArcDocument = ArcTexel.Parser.Document;
using ReferenceLayer = ArcTexel.Parser.ReferenceLayer;
using Variable = ArcTexel.Parser.Graph.Variable;

namespace ArcTexel.ViewModels.Document;

internal partial class DocumentViewModel
{
    public ArcDocument ToSerializable()
    {
        NodeGraph graph = new();
