...
using ArcTexel.Parser.Old.ArcV4.Interfaces;
...
/// </summary>
internal partial class ArcParserArcV4
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (FileVersion < version.minVersion)
        {
            throw new InvalidFileException(
                $".arc version {version.version} is not supported by this parser. Minimum supported version is {version.minVersion}. (Parser Version: {FileVersion})")
            {
