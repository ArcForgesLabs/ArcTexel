...
internal static class Helpers
{
    ...
    public static string CreateMakeChangeAction(MethodInfo changeConstructorInfo)
    {
        ...
        sb.AppendLine("using ArcTexel.ChangeableDocument.Changeables.Graph.Interfaces;");
        sb.AppendLine("namespace ArcTexel.ChangeableDocument.Actions.Generated;\n");
        sb.AppendLine("[System.Runtime.CompilerServices.CompilerGenerated]");
        sb.AppendLine($"public record class {actionName} : ArcTexel.ChangeableDocument.Actions.IMakeChangeAction");
        sb.AppendLine("{");
        ...
        (MethodInfo changeConstructorInfo, MethodInfo updateMethodInfo, ClassDeclarationSyntax containingClass, bool isCancelable)
    {
        ...
        sb.AppendLine("using ArcTexel.ChangeableDocument.Changeables.Graph.Interfaces;");
        sb.AppendLine("namespace ArcTexel.ChangeableDocument.Actions.Generated;");
        sb.AppendLine($"public record class {actionName} : ArcTexel.ChangeableDocument.Actions.IStartOrUpdateChangeAction" + (isCancelable ? ", ArcTexel.ChangeableDocument.Actions.ICancelableAction" : ""));
        sb.AppendLine("{");
        sb.Append($"public {actionName}");
        AppendArgumentList(sb, constructorArgs);
        ...
        sb.AppendLine($@"
bool ArcTexel.ChangeableDocument.Actions.IStartOrUpdateChangeAction.IsChangeTypeMatching(ArcTexel.ChangeableDocument.Changes.Change change)
{{
...
");
    ...
    public static string CreateEndChangeAction(MethodInfo changeConstructorInfo)
    {
        ...
        return 
$@"namespace ArcTexel.ChangeableDocument.Actions.Generated;

public record class {actionName} : ArcTexel.ChangeableDocument.Actions.IEndChangeAction
{{
    bool ArcTexel.ChangeableDocument.Actions.IEndChangeAction.IsChangeTypeMatching(ArcTexel.ChangeableDocument.Changes.Change change)
    {{
        return change is {changeConstructorInfo.ContainingClass.NameWithNamespace};
    }}
}}
";
    ...
    {
        sb.AppendLine("void ArcTexel.ChangeableDocument.Actions.IStartOrUpdateChangeAction.UpdateCorrespodingChange(ArcTexel.ChangeableDocument.Changes.UpdateableChange change)");
        sb.AppendLine("{");
    ...
    {
        sb.AppendLine("ArcTexel.ChangeableDocument.Changes.UpdateableChange ArcTexel.ChangeableDocument.Actions.IStartOrUpdateChangeAction.CreateCorrespondingChange()");
        sb.AppendLine("{");
    ...
    private static void AppendCreateCorrespondingChange
        (StringBuilder sb, NamespacedType corrChangeType, List<TypeWithName> propertiesToPass)
    {
        sb.AppendLine("ArcTexel.ChangeableDocument.Changes.Change ArcTexel.ChangeableDocument.Actions.IMakeChangeAction.CreateCorrespondingChange()");
        sb.AppendLine("{");
        sb.Append($"return new {corrChangeType.NameWithNamespace}(");
        for (int i = 0; i < propertiesToPass.Count; i++)
        {
