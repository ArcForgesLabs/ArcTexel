...
{
    private const string AttributesNamespace = "ArcTexel.ChangeableDocument.Actions.Attributes";
        ...
        (GeneratorSyntaxContext context, CancellationToken cancelToken)
    {
        ...
        if (!Helpers.IsInheritedFrom(classSymbol, new("UpdateableChange", "ArcTexel.ChangeableDocument.Changes")))
        {
        ...
        bool isCancelable = Helpers.IsInheritedFrom(classSymbol, new("CancelableUpdateableChange", "ArcTexel.ChangeableDocument.Changes"));
