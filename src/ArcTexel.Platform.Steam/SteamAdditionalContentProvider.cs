...
{
    Dictionary<string, AppId_t> dlcMap = new() { { "arctexel.founderspack", new AppId_t(2435860) }, };
    ...
    public async Task<string?> InstallContent(string productId)
    {
        ...
        string[] activeExtensions = Directory.GetFiles(extensionsDir, "*.arcext");
        ...
        string[] installedExtensions = Directory.GetFiles(extensionsDir, "*.arcext");
