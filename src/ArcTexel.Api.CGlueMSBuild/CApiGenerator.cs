...
public class CApiGenerator
{
    ...
    public static MethodDefinition[] GetExportedMethods(TypeDefinition[] types)
    {
        var exportedMethods = types
            ...
            .Where(m => m.IsStatic && m.CustomAttributes.Any(a => a.AttributeType.FullName == "ArcTexel.Extensions.Sdk.ApiExportAttribute"))
            .ToArray();
    ...
    {
        string exportName = method.CustomAttributes.First(a => a.AttributeType.FullName == "ArcTexel.Extensions.Sdk.ApiExportAttribute").ConstructorArguments[0].Value.ToString();
        StringBuilder sb = new StringBuilder();
