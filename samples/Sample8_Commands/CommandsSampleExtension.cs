...
public class CommandsSampleExtension : ArcTexelExtension
{
    /// <summary>
    ...
    public override void OnInitialized()
    {
        ...
        // Either an icon key (https://github.com/ArcTexel/ArcTexel/blob/master/src/ArcTexel.UI.Common/Fonts/ArcPerfectIcons.axaml)
        ...
        Api.Commands.InvokeCommand("ArcTexel.File.New");
