...
using ArcTexel.Extensions.Sdk.Api.Localization;

namespace LocalizationSample;

public class LocalizationSampleExtension : ArcTexelExtension
{
    /// <summary>
    ...
    public override void OnInitialized()
    {
        ...
        // By prepending "ArcTexel:" to the key, you can access built-in ArcTexel localization strings.
        // if you prepend any other extension unique name, you can access that extension localization strings.
        Api.Logger.Log(new LocalizedString("ArcTexel:SHOW_IMAGE_PREVIEW_TASKBAR"));
    }
}