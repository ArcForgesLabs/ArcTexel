...
namespace ArcTexel.Api.CGlueMSBuild.Tests;
...
public class CApiGeneratorTests
{
    ...
    public void TestThatAttachImportFunctionsGenerateProperly()
    {
        ...
        Assert.Contains("mono_add_internal_call(\"ArcTexel.Extensions.Sdk.Bridge.Native::subscribe_to_event\", internal_subscribe_to_event);", sanitizedImports);
    }
}
